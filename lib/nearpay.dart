...
class NearpayProxy {
  ...
  NearpayProxy(this._nearpay);

  Future<void> showConnection() async {
    await _nearpay._callAndReturnMapResponse("proxyShowConnection", {});
  }

  Future<void> disconnect() async {
    await _nearpay._callAndReturnMapResponse("proxyDisconnect", {});
  }
}
